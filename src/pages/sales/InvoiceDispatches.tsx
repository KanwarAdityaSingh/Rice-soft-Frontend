...
import { InvoiceDispatchesTable } from '../../components/sales/invoice-dispatches/InvoiceDispatchesTable';
import { InvoiceDispatchFormModal } from '../../components/sales/invoice-dispatches/InvoiceDispatchFormModal';

export default function InvoiceDispatchesPage() {
  ...
  return (
    <div className="container mx-auto py-6 sm:py-10 space-y-6 sm:space-y-8 px-4 sm:px-6">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">
              <span className="text-gradient">Invoice Dispatches</span>
            </h1>
            <p className="mt-1 sm:mt-2 text-sm sm:text-base text-muted-foreground">
              Create and confirm outbound invoices; generate e-invoice and e-way bill
            </p>
          </div>
          <button
      ...
      <InvoiceDispatchesTable onRefreshRef={tableRefreshRef} />
