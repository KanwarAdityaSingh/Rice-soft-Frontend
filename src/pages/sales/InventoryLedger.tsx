import { InventoryLedgerTable } from '../../components/sales/inventory-ledger/InventoryLedgerTable';
      ...
      <header className="hero-bg rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="relative">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">
            <span className="text-gradient">Inventory Ledger</span>
          </h1>
          <p className="mt-1 sm:mt-2 text-sm sm:text-base text-muted-foreground">
            View inventory movements (sales dispatch, sale return, purchase inward, adjustment)
          </p>
        </div>
      </header>
