...
import { PackagingVendorsTable } from '../../components/production/packaging-vendors/PackagingVendorsTable';

export default function PackagingVendorsPage() {
  return (
      ...
      <header className="hero-bg rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="relative">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold">
            <span className="text-gradient">Packaging Vendors</span>
          </h1>
          <p className="mt-1 sm:mt-2 text-sm sm:text-base text-muted-foreground">
            Manage packaging vendors and their information
          </p>
        </div>
      </header>

      <PackagingVendorsTable />
    </div>
  );
}
