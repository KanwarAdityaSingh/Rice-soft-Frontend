import { InwardSlipPassesTable } from '../../components/purchases/inward-slip-passes/InwardSlipPassesTable';

export default function InwardSlipPassesPage() {
  return (
    <div className="container mx-auto py-6 sm:py-10 space-y-6 sm:space-y-8 px-4 sm:px-6">
      <header className="hero-bg rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="mt-1 sm:mt-2 text-sm sm:text-base text-muted-foreground">Manage inward slip passes</p>
        </div>
      </header>

      <InwardSlipPassesTable />
    </div>
  );
}
