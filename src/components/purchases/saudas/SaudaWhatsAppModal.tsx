...
export function SaudaWhatsAppModal({
  open,
  onOpenChange,
  saudaId,
  onSuccess,
}: SaudaWhatsAppModalProps) {
  ...
  const handleSendWhatsApp = async () => {
    ...
    try {
      ...
      const result = await saudasAPI.sendViaWhatsApp(saudaId, validNumbers, {
        customMessage: whatsappMessage || undefined,
          ...
          <div className="glass rounded-xl sm:rounded-2xl shadow-2xl flex flex-col h-full max-h-[90vh]">
            ...
            <div className="flex items-center justify-between p-6 border-b border-border/50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <Dialog.Title className="text-xl sm:text-2xl font-bold">Send Sauda via WhatsApp</Dialog.Title>
